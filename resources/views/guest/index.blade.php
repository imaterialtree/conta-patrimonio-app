...
@section('content')
    ...
    <div class="mt-3 text-center">
        <p>Bem-Vindo ao Conta Patrimônio.</p>
        <p>Veja a lista completa de patriônios ou use os botões a abaixo para pesquisar um
            Patrimônio específico.</p>
    </div>

    <div class="col-md-4 mb-3 mx-auto mb-auto">
        <x-card-btn>
